	...
	public partial class SalesReport : Form
	{
		...
		private void btnShow_Click(object sender, EventArgs e)
		{
			try
			{
				...
				cmd.Connection = con;
				con.Open();
				cmd.CommandText = @"Select m.TransactionDate, cs.Name, p.ProductName , c.CategoryName,u.UnitName,m.GrandTotal,m.Vat,m.Discount,d.Quantity,d.Rate as [Sales Rate], d.Total from TransactionDetail d inner join TransactionMaster m on m.TransactionMasterId=d.TransactionMasterId 
